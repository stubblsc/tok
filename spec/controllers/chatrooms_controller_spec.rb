...
RSpec.describe ChatroomsController, type: :controller do
  ...
  #     chatroom = Chatroom.create! valid_attributes
  #     get :show, params: {id: chatroom.to_param}, session: valid_session
  ...
  #   it "assigns the requested chatroom as @chatroom" do
  #     chatroom = Chatroom.create! valid_attributes
  #     get :edit, params: {id: chatroom.to_param}, session: valid_session
  #     expect(assigns(:chatroom)).to eq(chatroom)
  #   end
  # end
  #
  ...
  #       expect {
  #         post :create, params: {chatroom: valid_attributes}, session: valid_session
  #       }.to change(Chatroom, :count).by(1)
  #     end
  #
  #     it "assigns a newly created chatroom as @chatroom" do
  #       post :create, params: {chatroom: valid_attributes}, session: valid_session
  #       expect(assigns(:chatroom)).to be_a(Chatroom)
  #       expect(assigns(:chatroom)).to be_persisted
  #     end
  #
  ...
  #       post :create, params: {chatroom: invalid_attributes}, session: valid_session
  #       expect(assigns(:chatroom)).to be_a_new(Chatroom)
  #     end
  #
  ...
  #       chatroom = Chatroom.create! valid_attributes
  #       put :update, params: {id: chatroom.to_param, chatroom: new_attributes}, session: valid_session
  #       chatroom.reload
  ...
  #     it "assigns the requested chatroom as @chatroom" do
  #       chatroom = Chatroom.create! valid_attributes
  #       put :update, params: {id: chatroom.to_param, chatroom: valid_attributes}, session: valid_session
  #       expect(assigns(:chatroom)).to eq(chatroom)
  #     end
  #
  ...
  #       chatroom = Chatroom.create! valid_attributes
  #       put :update, params: {id: chatroom.to_param, chatroom: invalid_attributes}, session: valid_session
  #       expect(assigns(:chatroom)).to eq(chatroom)
  #     end
  #
  ...
  #     chatroom = Chatroom.create! valid_attributes
  #     expect {
  #       delete :destroy, params: {id: chatroom.to_param}, session: valid_session
  #     }.to change(Chatroom, :count).by(-1)
  #   end
  #
